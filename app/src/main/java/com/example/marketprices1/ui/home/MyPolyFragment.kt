...
import com.example.marketprices1.databinding.MyFragmentPolyBinding
...
class MyPolyFragment : Fragment() {
    ...
    private lateinit var binding: MyFragmentPolyBinding
    private lateinit var customAdapterFruit: CustomAdapterFruit
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = MyFragmentPolyBinding.inflate(layoutInflater)
        (context as AppCompatActivity).supportActionBar?.title="Poliz ekinlari"
