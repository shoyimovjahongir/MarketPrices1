...
import com.example.marketprices1.databinding.MyFragmentDeviseBinding
...
class MyDeviseFragment : Fragment() {
    ...
    private lateinit var binding: MyFragmentDeviseBinding
    private lateinit var customAdapterFruit: CustomAdapterFruit
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = MyFragmentDeviseBinding.inflate(layoutInflater)
        (context as AppCompatActivity).supportActionBar?.title="Texnik buyumlar"
