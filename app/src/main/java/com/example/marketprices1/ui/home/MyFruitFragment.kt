...
class MyFruitFragment : Fragment() {
    ...
    private lateinit var binding: MyFragmentFruitBinding
    private lateinit var customAdapterFruit: CustomAdapterFruit
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = MyFragmentFruitBinding.inflate(layoutInflater)
        (context as AppCompatActivity).supportActionBar?.title="Mevalar"
